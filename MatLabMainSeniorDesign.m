...
%change below and for now we have to keep image at img3_3, other wise pixel amount will change edge detection for circles,
%keep undistortImage commented out as well due to pixel differnce 
%didn't comment that much so good luck and sorry for grammer
%additional folder has each function individually to get more info without cluttering main
Directory2Zip='<directory to this  Zip>'
